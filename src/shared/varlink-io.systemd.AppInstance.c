...
static SD_VARLINK_DEFINE_METHOD(
                ...
                SD_VARLINK_FIELD_COMMENT("The sandbox engine registering this app (if any), in RDNS format (i.e. org.flatpak)"),
                ...
                SD_VARLINK_DEFINE_INPUT(permissions, SD_VARLINK_OBJECT, SD_VARLINK_MAP|SD_VARLINK_NULLABLE),
                SD_VARLINK_FIELD_COMMENT("Entitlements held by this app"),
                SD_VARLINK_DEFINE_INPUT(entitlements, SD_VARLINK_OBJECT, SD_VARLINK_MAP|SD_VARLINK_NULLABLE));
...
static SD_VARLINK_DEFINE_METHOD(
                ...
                SD_VARLINK_DEFINE_OUTPUT(permissions, SD_VARLINK_OBJECT, SD_VARLINK_MAP),
                SD_VARLINK_FIELD_COMMENT("Instance's held entitlements"),
                SD_VARLINK_DEFINE_OUTPUT(entitlements, SD_VARLINK_OBJECT, SD_VARLINK_MAP));
...
static SD_VARLINK_DEFINE_METHOD(
                ...
                SD_VARLINK_DEFINE_INPUT(permissions, SD_VARLINK_OBJECT, SD_VARLINK_MAP));

static SD_VARLINK_DEFINE_ERROR(
                ConflictingIdentity,
                SD_VARLINK_FIELD_COMMENT("The existing app ID"),
                SD_VARLINK_DEFINE_FIELD(id, SD_VARLINK_STRING, 0),
                SD_VARLINK_FIELD_COMMENT("The existing collection ID"),
                SD_VARLINK_DEFINE_FIELD(collection, SD_VARLINK_STRING, 0),
                SD_VARLINK_FIELD_COMMENT("The existing sandbox engine"),
                SD_VARLINK_DEFINE_FIELD(sandbox, SD_VARLINK_STRING, SD_VARLINK_NULLABLE));
...
SD_VARLINK_DEFINE_INTERFACE(
                ...
                SD_VARLINK_SYMBOL_COMMENT("Register an instance of an app"),
                &vl_method_Register,
                ...
                &vl_type_ProcessId,
                SD_VARLINK_SYMBOL_COMMENT("This instance has already registered with a conflicting identity"),
                &vl_error_ConflictingIdentity,
                SD_VARLINK_SYMBOL_COMMENT("The targetPid and targetConnection don't refer to the same process"),
                &vl_error_ConflictingTarget,
                SD_VARLINK_SYMBOL_COMMENT("Failed to find the target instance"),
                &vl_error_NoSuchInstance,
                SD_VARLINK_SYMBOL_COMMENT("Permissions have changed since you last "),
                &vl_error_Stale);
